...
class AddSliderTablet extends StatefulWidget {
  const AddSliderTablet({super.key});

  @override
  State<AddSliderTablet> createState() => _AddSliderTabletState();
}

class _AddSliderTabletState extends State<AddSliderTablet> {
