...
class AddSliderDeskTop extends StatefulWidget {
  const AddSliderDeskTop({super.key});

  @override
  State<AddSliderDeskTop> createState() => _AddSliderDeskTopState();
}

class _AddSliderDeskTopState extends State<AddSliderDeskTop> {
    ...
    return Scaffold(
        ...
        body: Row(
          children: [
            ...
            Expanded(
              child: _buildAddSliderTemplate(),
            ),
          ],
        ));
  }

  Widget _buildAddSliderTemplate() {
    return Padding(
