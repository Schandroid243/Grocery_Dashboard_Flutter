...
class AddRelatedProductTablet extends StatefulWidget {
  const AddRelatedProductTablet({super.key});

  @override
  State<AddRelatedProductTablet> createState() =>
      _AddRelatedProductTabletState();
}

class _AddRelatedProductTabletState extends State<AddRelatedProductTablet> {
