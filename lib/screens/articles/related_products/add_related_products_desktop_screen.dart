...
class AddRelatedProductDeskTop extends StatefulWidget {
  const AddRelatedProductDeskTop({super.key});

  @override
  State<AddRelatedProductDeskTop> createState() =>
      _AddRelatedProductDeskTopState();
}

class _AddRelatedProductDeskTopState extends State<AddRelatedProductDeskTop> {
    ...
    return Scaffold(
      ...
      body: Row(
        children: [
          ...
          Expanded(
            child: _buildAddRelatedProductTemplate(),
          ),
        ],
      ),
    );
  ...
  Widget _buildAddRelatedProductTemplate() {
    return Center(
      child: Padding(
  ...
  void _addRelatedProduct() {
    ...
    } else if (articleController.selectedArticleFromTheList!.productId ==
        relatedProduct.productId) {
      FormHelper.showSimpleAlertDialog(
          context,
          Config.appName,
          "Veuillez sélectionner un article différent de l'article parent !",
          "Ok", () {
        Navigator.of(context).pop();
      });
    } else {
