...
class AddCategoryDeskTop extends StatefulWidget {
  const AddCategoryDeskTop({super.key});

  @override
  State<AddCategoryDeskTop> createState() => _AddCategoryDeskTopState();
}

class _AddCategoryDeskTopState extends State<AddCategoryDeskTop> {
    ...
    return Scaffold(
      ...
      body: Row(
        children: [
          ...
          Expanded(
            child: _buildAddCategoryTemplate(),
          ),
        ],
      ),
    );
  ...
  Widget _buildAddCategoryTemplate() {
    return Padding(
            ...
            decoration: InputDecoration(
              ...
              focusedBorder: OutlineInputBorder(
                borderSide: BorderSide(
                    color:
                        Colors.grey[900]!), // Change focused border color here
                borderRadius: BorderRadius.circular(
                    8.0), // Adjust border radius as needed
              ),
            ),
