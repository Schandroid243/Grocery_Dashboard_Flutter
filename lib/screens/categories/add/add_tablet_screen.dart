...
class AddCategoryTablet extends StatefulWidget {
  const AddCategoryTablet({super.key});

  @override
  State<AddCategoryTablet> createState() => _AddCategoryTabletState();
}

class _AddCategoryTabletState extends State<AddCategoryTablet> {
